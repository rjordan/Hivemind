class CreateConversations < ActiveRecord::Migration[8.0]
  def change
    ...
    create_table :characters_conversations, id: :uuid do |t|
    ...
    add_index :characters_conversations, [:conversation_id, :character_id], unique: true, name: 'index_characters_conversations_on_conversation_and_user'
